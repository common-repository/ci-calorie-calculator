...
Tags: calorie calculator, daily calorie intake, calorie counting, weight loss calculator, nutritional needs
...
[https://www.calculator.io/calorie-calculator/](https://www.calculator.io/calorie-calculator/)
...
`<?php display_calcio_calorie_calculator(); ?>`
...
1. Upload the Calorie Calculator /calcio_calorie_calculator/ folder to the /wp-content/plugins/ directory.
2. Activate the Calorie Calculator plugin through the "Plugins" menu in WordPress.

== Changelog ==

= 1.0.0 =
* Initial release of Calorie Calculator
